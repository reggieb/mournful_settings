...
to order your initializers or define the cipher settings in a before_initialize
block defined in config/application:
...
- Add the configuration code to the app
- Start the server
